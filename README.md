...
- [LinkedIn](https://www.linkedin.com/in/iasonasgeorgiadis/)  
- [Portfolio](https://www.iasonasgeorgiadis.com)  
- [Medium](https://medium.com/@iasonasgeorgiadis)

## Professional Experience

- **Lead Product Designer, Wiley** *(2022–Present)*  
- **Senior Product Designer, Wiley** *(2020–2022)*  
- **Senior UX/UI Designer, Wiley** *(2018–2020)*  
- **UX/UI Designer, Lighthouse SA** *(2013–2018)*

## Skills

- Design Leadership and Strategy: Design Systems, accessibility (WCAG 2.2), cross-functional collaboration, design mentoring, and team management  
- Product Design and Front-end: Figma, Storybook, HTML, CSS, JavaScript, React
- Full-Stack Development (in training)**
- Java, MySQL, Node.js, TypeScript  
- AI and Tooling: Figma MCP Server and Code Connect, Claude Code, Codex CLI, Cursor, Lovable, Bolt  
- Workflow and Operations: GitHub, VS Code, Jira
...
- Designing and maintaining scalable systems that bridge design and development.
- Exploring AI-assisted tools such as Figma MCP Server, Claude Code, and Codex CLI.
- Writing about design systems and AI workflows on [Medium](https://medium.com/@iasonasgeorgiadis).
